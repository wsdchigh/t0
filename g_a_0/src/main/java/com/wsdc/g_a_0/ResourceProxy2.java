 ...
 *          <li>    让local去取出来
 */
public class ResourceProxy2 extends Resources{
    ...
    public ResourceProxy2(AssetManager assets, DisplayMetrics metrics, Configuration config) {
        super(assets, metrics, config);
    }

    public ResourceProxy2(AssetManager assets) {
        /*
         *   针对任何一个APK文件，创建一个
         */
